...
Heure::Heure(const char *heure) : h_(0), m_(0) {
    ...
    long c = p - heure;
    h_ =(int) strtol(heure, nullptr, 10);
    heure = &heure[c + 1];
    m_ = (int) strtol(heure, nullptr, 10);
    if(erreur_(h_, m_)){
        h_ = 0;
        m_ = 0;
    }
...
Heure &Heure::operator=(const char *h) {
    ...
    long c = p - h ;
    h_ =(int) strtol(h, nullptr, 10);
    h = &h[c + 1];
    m_ = (int) strtol(h, nullptr, 10);
    if(erreur_(h_, m_)){
        h_ = 0;
        m_ = 0;
    }
